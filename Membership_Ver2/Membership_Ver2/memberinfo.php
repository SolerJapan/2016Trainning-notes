<?php
	 ...
	 {
		//edit the 2 lines below as needed
        $email_to ="solerjapan@gmail.com";
        ...
        function died($error)
        {
			...
			echo $error."<br/></br>";
			echo "please go back and fix there errors. <br/><br/>";
			die();
		}
			
		//validation  PHP stands for  Hypertext Preprocessor	
		if(!isset($_POST['fname'])||
		   ...
		   !isset($_POST['message']))
		   {
			   died('we are very sorry.there appears to be a problem with the form you submitted');
		   }
		//required
		...
		?>
		<p>
		<h3>Thank You for contacting us; we will be in touch soon.</h3>
		</p>
...
<meta name="keywords" content="web design,asp.net,C sharp,sql server 2012, html5, css,Global, Data Report,MVC,Customer Services," />
...
<div id="tooplate_body_wrapper">
	<!-- <div id="tooplate_wrapper">-->
        ...
        <div id="tooplate_header">
            ...
            <div id="header_right">
                <div id="social_links">
                    <a href="mailto:solera1@student.wpunj.edu"><img src="images/mail.png" alt="Contact" /></a>
                    <a href="https://www.facebook.com"><img src="images/facebook_01.png" alt="Facebook" /></a>
                    <a href="https://www.linkedin.com/nhome"><img src="images/linkedin_01.png" alt="Linkedin" /></a>            
                </div>
		...
		<!--	<p><strong>Please fill out the form so we can get back to you as soon as we can </strong></p>
            <form id="form1" name="formal" method="post" action="memberinfo.php">
			<table with="67%" height="186" border ="0">
			  <tr>
			   ...
			   <tr>
				 ...
				 <td width="83%">
				 <span id="sprytextfield1">
				 <label for "lname2"></label>
				 <input name="lname" type="text" id="lname2" size="35"/>
			...
			<tr>
			 ...
			 <tr>
			     <td width="17%">Comments/Questions :</td>
				 <td width="83%">
				  <span id="sprytextfield1"> 
				 <label for "message"></label>
				 <textarea name="message" type="text" id="message" cols="35" rows="20"/>please enter your question/comment</textarea>
				 </td>			 
			  </tr> 
			  <tr>
			  <td>&nbsp;</td>
