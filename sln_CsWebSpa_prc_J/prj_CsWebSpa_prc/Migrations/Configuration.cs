namespace prj_CsWebSpa_prc.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<prj_CsWebSpa_prc.Models.tDbcxt>
    {
        ...
        protected override void Seed(tDbcxt oDbcxt)
        {
            ...
            oDbcxt.p_oDbsetOfAuth.AddOrUpdate(auth => auth.p_oStrName,
            ...
            oDbcxt.p_oDbsetOfBook.AddOrUpdate(bk => bk.p_oStrTitle,
